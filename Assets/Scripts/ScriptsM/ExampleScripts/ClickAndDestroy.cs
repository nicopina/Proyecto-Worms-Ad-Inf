...
namespace DTerrain
{
    ...
    public class ClickAndDestroy : MonoBehaviour
    {
        ...
        public void Start()
        {
            primaryLayer = GameObject.Find("CollidableLogicLayer").GetComponent<BasicPaintableLayer>();
            secondaryLayer = GameObject.Find("VisibleLayer").GetComponent<BasicPaintableLayer>();
